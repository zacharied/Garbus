...
{
    [TestFixture]
    public partial class TestSceneSlamEdgeStream : HitObjectStreamTestScene
    {
        ...
        protected override void PopulateChart(GarbusChart chart)
        {
            ...
            {
                chart.HitObjects.Add(new GarbusSlamEdge
                {
                    ...
                    Direction = i % 2 == 0 ? RotationalDirection.Clockwise : RotationalDirection.Anticlockwise,
                });
            }
        }
    }
