// Vendored from osu.Game (https://github.com/ppy/osu) — osu.Game/Rulesets/Judgements/JudgementResult.cs
...
namespace Garbus.Game.Gameplay.Judgements
{
    ...
    public class JudgementResult
    {
        ...
        /// <summary>
        /// The <see cref="Judgements.Judgement"/> which this <see cref="JudgementResult"/> applies for.
        /// </summary>
        ...
        /// <summary>
        /// The absolute time at which this <see cref="JudgementResult"/> occurred, clamped by the end time of <see cref="HitObject"/> plus <see cref="Objects.HitObject.MaximumJudgementOffset"/>.
        /// </summary>
        /// <remarks>
        ...
        /// <param name="judgement">The <see cref="Judgements.Judgement"/> to refer to for scoring information.</param>
