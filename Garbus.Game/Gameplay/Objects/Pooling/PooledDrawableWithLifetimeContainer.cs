// Vendored from osu.Game (https://github.com/ppy/osu) — osu.Game/Rulesets/Objects/Pooling/PooledDrawableWithLifetimeContainer.cs
...
namespace Garbus.Game.Gameplay.Objects.Pooling
{
    /// <summary>
