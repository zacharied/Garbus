// Vendored from osu.Game (https://github.com/ppy/osu) — osu.Game/Screens/Edit/Compose/Components/Timeline/ZoomableScrollContainer.cs
// Copyright (c) ppy Pty Ltd <contact@ppy.sh>. Licensed under the MIT Licence.
// See https://github.com/ppy/osu/blob/master/LICENCE for full licence text.
// Adapted for Garbus: OsuScrollContainer → BasicScrollContainer (no osu.Game.Graphics dependency);
// IFrameBasedClock resolution removed (Garbus wires the editor clock differently); namespace changed.
