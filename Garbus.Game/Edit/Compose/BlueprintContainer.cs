// Vendored from osu.Game (https://github.com/ppy/osu) — osu.Game/Screens/Edit/Compose/Components/BlueprintContainer.cs
// Copyright (c) ppy Pty Ltd <contact@ppy.sh>. Licensed under the MIT Licence.
// See https://github.com/ppy/osu/blob/master/LICENCE for full licence text.
// Adapted for Garbus: namespace Garbus.Game.Edit.Compose; osu.Game types replaced with local
// equivalents (IEditorChangeHandler → Garbus.Game.Edit.IEditorChangeHandler;
// OsuContextMenuContainer dependency dropped — SelectionHandler handles context menus directly);
// GlobalAction key bindings dropped (osu.Game-only, Garbus has no equivalent);
// JetBrains annotations removed; nullable enabled.
...
namespace Garbus.Game.Edit.Compose
{
    ...
    public abstract partial class BlueprintContainer<T> : CompositeDrawable, IKeyBindingHandler<PlatformAction>
        where T : class
    {
        protected DragBox DragBox { get; private set; } = null!;

        public SelectionBlueprintContainer SelectionBlueprints { get; private set; } = null!;
        ...
        public SelectionHandler<T> SelectionHandler { get; private set; } = null!;
