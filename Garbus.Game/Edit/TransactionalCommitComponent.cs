// Vendored from osu.Game (https://github.com/ppy/osu) — osu.Game/Screens/Edit/TransactionalCommitComponent.cs
// Copyright (c) ppy Pty Ltd <contact@ppy.sh>. Licensed under the MIT Licence.
// See https://github.com/ppy/osu/blob/master/LICENCE for full licence text.
// Adapted for Garbus: namespace changed to Garbus.Game.Edit; osu.Framework.Graphics.Component base
// retained (TransactionalCommitComponent is abstract and non-visual, Component adds minimal overhead).
