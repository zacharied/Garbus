...
// chord, inscribed at the chord's shared (co-radial) distance from centre. In ordinary gameplay it lives
// below the hit-object layers; in Mini it lives above them but below judgement feedback and the outer ring.
// Geometry comes from ChordHighlighter + ProgressAtTime, so it keeps its full shape while the chord is
